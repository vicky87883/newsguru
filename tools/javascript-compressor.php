...
<div class="sidebar">
    <h2>Toolbox</h2>
    <a href="javascript-compressor" class="active"><i class="fas fa-compress"></i> JavaScript Compressor</a>
...
<div class="main-content">
    <div class="container">
        ...
        <p>Upload your JavaScript file to compress it.</p>
        <div class="upload-btn-wrapper">
            <button class="btn"><i class="fas fa-upload"></i> Upload JavaScript File</button>
...
<!-- Include Terser library from CDN -->
<script src="https://cdn.jsdelivr.net/npm/terser/dist/bundle.min.js"></script>
<script>
    document.getElementById('jsFileInput').addEventListener('change', async function(event) {
        ...
        reader.onload = async function(e) {
            ...
            try {
                // Use Terser to compress the JavaScript code
                ...
                // Create a Blob with the minified code
                ...
                console.error('Error compressing the JavaScript file:', error);
