...
<h1>Write for Us</h1>
        <p>The newsguru welcomes unsolicited articles, blog posts, and other forms of content. If you are interested in writing for us, please write to us at <a href="mailto:editorial@newsguru.live">editorial@newsguru.live</a>.</p>
        
        <h2>What We Are Looking For</h2>
        <ul>
            <li>Reportage</li>
            <li>Legal analysis of judgment and court orders</li>
            <li>Pieces on political and current events from a legal or rights-based perspective</li>
            <li>Analysis of contemporary legal or policy issues</li>
            <li>Movie/TV Show/book reviews – ideally related to legal or rights-based issues</li>
            <li>Poetry, art, and visual work</li>
        </ul>
        
        <h2>Guidelines for Submissions</h2>
        <ul>
            <li>No deadline – submissions accepted year-round. Current affairs pieces should be timely.</li>
            <li>Original, unpublished works only. Do not send previously published pieces.</li>
            <li>Ensure all information is accurate and sourced.</li>
            <li>Include a one-line bio and social media handles.</li>
            <li>Submit in Word format only, not PDF.</li>
            <li>Zero-tolerance policy towards plagiarism.</li>
            <li>Include an undertaking that the piece is not submitted elsewhere.</li>
            <li>Attach a high-resolution photograph of the author.</li>
            <li>Due to volume, we'll contact you only if we can accept your piece.</li>
            <li>The editor's word is final.</li>
        </ul>
        
        <h2>Guidelines on Style for Authors</h2>
        <ul>
            <li><strong>Word Count:</strong></li>
            <ul>
                <li>Reportage: 600 – 1200 words.</li>
                <li>Short Analysis: 1000 – 1500 words.</li>
                <li>Long-form/Explainers: 1500 – 2500 words.</li>
            </ul>
            <li><strong>Headlines/titles:</strong> Must be crisp and capture the essence of the article.</li>
            <li><strong>Introductions:</strong> Features should have a short intro in italics with your byline in bold.</li>
            <li><strong>References:</strong> Hyperlink all references in the text. Use in-text citations if no online source is available.</li>
            <li><strong>Language:</strong></li>
            <ul>
                <li>Use British spelling and grammar, but retain American spellings in quoted documents.</li>
                <li>Italicize non-English terms and provide translations.</li>
                <li>Avoid archaic, colonial, sexist, or prejudicial language.</li>
                <li>Use simple terms to avoid jargon and legalese.</li>
            </ul>
            <li><strong>Quotes:</strong> Use quotes that add unique value. Paraphrase if necessary.</li>
            <li><strong>Dates:</strong> Use the format "January 26, 2020".</li>
        </ul>
        
        <p>The newsguru reserves the right to edit submissions to meet our writing style and quality standards.</p>
</div>
</div>
</div>
</main>
