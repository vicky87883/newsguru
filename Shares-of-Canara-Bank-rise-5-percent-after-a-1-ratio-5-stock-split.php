...
<title>Shares of Canara Bank rise 5% after a 1:5 stock split. Experts predict greater benefits.</title>
<meta name=news_keywords content="Shares of Canara Bank rise 5% after a 1:5 stock split. Experts predict greater benefits." itemprop="keywords"/>
<meta name=description content="Shares of Canara Bank rise 5% after a 1:5 stock split. Experts predict greater benefits." itemprop="description"/>
<meta name=viewport content="width=device-width, initial-scale=1">
<link rel=canonical href=https://www.newsguru.live/Shares-of-Canara-Bank-rise-5-percent-after-a-1-ratio-5-stock-split.php />
...
Shares of Canara Bank rise 5% after a 1:5 stock split. Experts predict greater benefits.
</h1>
<div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
<span class=post-by>By Newsguru Editors</span>
<span class=post-on>2024-05-14T12:38:34Z</span>
...
<img src=assets/imgs/news/canara.webp alt=blog width=100%>
<div class="credit mt-15 font-small color-grey">
<i class="ti-credit-card mr-5"></i><span>Image credit: additional resources.</span>
</div>
</figure>
<div class=single-excerpt>
	<p><mark>Recently, the board of Canara Bank announced a subdivision of shares, reducing the face value of each equity share from ₹10 to ₹2.</mark></p>
	<p>A significant player in the PSU bank stock market, Canara Bank shares, saw a spike in purchasing activity today in connection with the stock trading ex-split. The board of directors predetermined this historic event when they established May 15, 2024, as the record date for the 1:5 stock split. Canara Bank shares closed at ₹113.30 a share on the NSE on Tuesday, adjusted for the split. Tuesday's adjusted close price of ₹113.30 per share was significantly increased by 5% to the post-adjustment starting price of ₹116.25 per share on the NSE today, which reached a high for the day of ₹118.90 per share.</p>
...
<script>
	...
	<p>Experts in the stock market predict that the stock split will increase trading activity for Canara Bank shares, which are currently valued favorably. After the split, the shares can be purchased for a potentially beneficial PE multiple of 1.47, which suggests that the PSU bank has effectively controlled its funding costs. In the post-stock split phase, these analysts predict that Canara Bank shares would rise even higher, providing investors with a possible chance.</p>
	<h5 style="color:red;">Canara Bank share price target</h5>
	<ins class="adsbygoogle"
     style="display:block; text-align:center;"
     data-ad-layout="in-article"
     data-ad-format="fluid"
...
<script>
	...
	<p>Vice President—Research at SMC Global Securities Saurabh Jain said, "With the recent peak in interest rates, the cost of funding has emerged as a crucial factor in selecting a banking stock." Jain was giving his thoughts on Canara Bank's share price prediction. Despite being lower than its rivals, Canara Bank's CASA ratio points to a prospective low cost of funding and strong income in the next quarters. Canara Bank shares are anticipated to outperform their counterparts in the years to come because to this advantage."
</p>
	<p>Prabhudas Lilladher's Technical Research Analyst, Shiju Koothupalakkal, offered his technical analysis of shares of Union Bank and Canara Bank. He clarified, saying, "At the moment, Canara Bank is encountering resistance between ₹119 and ₹120 per piece. But if this barrier is overcome, we should anticipate that the state-owned stock would rise over its current record high of ₹126.58 and reach new heights."</p>
	<ins class="adsbygoogle"
     style="display:block; text-align:center;"
     data-ad-layout="in-article"
     data-ad-format="fluid"
...
<script>
	...
	<h5 style="color:red;">Canara Bank stock split</h5>
	<p>A stock subdivision was recently announced by the Canara Bank board, with each shares of stock being valued at ₹2 instead of the current face value of ₹10 per share. The board also decided to record the stock split on May 15, 2024.</p>
</div>
