...
<title>OpenAI says it will encourage something amazing on May 13; Sam Altman says it's not a Google Search competitor</title>
<meta name=news_keywords content="OpenAI says it will encourage something amazing on May 13; Sam Altman says it's not a Google Search competitor" itemprop="keywords"/>
<meta name=description content="OpenAI says it will encourage something amazing on May 13; Sam Altman says it's not a Google Search competitor
" itemprop="description"/>
<meta name=viewport content="width=device-width, initial-scale=1">
<link rel=canonical href="https://www.newsguru.live/technology/OpenAI-says-it-will-encourage-something-amazing-on-May-13.php" />
...
OpenAI says it will encourage something amazing on May 13; Sam Altman says it's not a Google Search competitor
</h1>
<div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
<span class=post-by>By Newsguru Editors</span>
<span class=post-on>2024-05-11T19:46:34Z</span>
...
<img src="assets/imgs/news/sam.webp" alt=blog width=100%>
<div class="credit mt-15 font-small color-grey">
<i class="ti-credit-card mr-5"></i><span>Image credit: additional resources.</span>
</div>
</figure>
<div class=single-excerpt>
<p><mark>	The CEO of OpenAI, Sam Altman, denied claims that the company was getting ready to introduce a Google Search.</mark>
	</p>
	<p>The CEO of OpenAI, Sam Altman, has denied claims that the company was getting ready to introduce a Google Search alternative in the near future. Though it won't be to introduce a next-generation GPT-5, OpenAI does have an event planned for May 13, just a few hours before Google's I/O 2024 developer conference begins. Rather, at its event on May 13, OpenAI will reveal new "ChatGPT and GPT-4" improvements.
	</p>
	<p>
In a post on X, the platform formerly known as Twitter, Altman went so far as to call the new updates magical. There was much conjecture that OpenAI was quietly developing a rival search engine to Google, and given that it has been able to challenge Google in generative AI, it was expected that the OpenAI search engine could be at least competitive.</p>
	<!-- displayads2 -->
...
<script>
	...
	<h5 style="color:red;">OpenAI May 13 ChatGPT event details</h5>

	<p>In a post on X, OpenAI announced that it will hold a live stream on May 13 to reveal "some ChatGPT and GPT-4 updates." Sam Altman wrote from his own X account, "Not gpt-5, not a search engine, but we've been hard at work on some new stuff we think people will love! feels like magic to me. Monday 10am PT."
	</p>
	<p>
As of this writing, the OpenAI website is promising "Spring Updates" with glimpses of the upcoming features.
	</p>
	<!-- displayads2 -->
<ins class="adsbygoogle"
     style="display:block"
...
<script>
	...
	<p>
OpenAI stated, "We'll be streaming live on http://openai.com on Monday, May 13 at 10AM PT to demo some ChatGPT and GPT-4 updates."
	</p>
	<p>
According to a Bloomberg article earlier this week, the goal of adding new features is to more successfully compete with Google and Perplexity, two products of Alphabet Inc.
	</p>
	<!-- displayads2 -->
<ins class="adsbygoogle"
     style="display:block"
...
<script>
	...
	<p>
Users can ask questions of ChatGPT and receive answers that pull data from the internet and provide citations, thanks to a few additional capabilities. According to experts, the most recent updates may also give you written responses in addition to images when necessary. We anticipate more information.</p>
</div>
