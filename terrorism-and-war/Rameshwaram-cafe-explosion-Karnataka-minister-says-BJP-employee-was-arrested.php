...
<title>Rameshwaram cafe explosion: Karnataka minister says BJP employee was arrested, but NIA advises against believing unconfirmed news reports | Latest News  - Newsguru.live</title>
<meta name=news_keywords content="Rameshwaram cafe explosion: Karnataka minister says BJP employee was arrested, but NIA advises against believing unconfirmed news reports" itemprop="keywords"/>
<meta name=description content="Rameshwaram cafe explosion: Karnataka minister says BJP employee was arrested, but NIA advises against believing unconfirmed news reports" itemprop="description"/>
<meta name=viewport content="width=device-width, initial-scale=1">
<link rel=canonical href="https://www.newsguru.live/terrorism-and-war/Rameshwaram-cafe-explosion-Karnataka-minister-says-BJP-employee-was-arrested.php" />
...
Rameshwaram cafe explosion: Karnataka minister says BJP employee was arrested, but NIA advises against believing unconfirmed news reports
</h1>
<div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
<span class=post-by>By Newsguru Editors</span>
<span class=post-on>04-06-2024 12:05:19</span>
...
<img src=assets/imgs/news/cafe.webp alt=blog width=100%>
<div class="credit mt-15 font-small color-grey">
<i class="ti-credit-card mr-5"></i><span>Image credit: additional resources.</span>
</div>
</figure>
<div class=single-excerpt>
	<p>NEW DELHI: On Friday, Dinesh Gundu Rao, the health minister for Karnataka, announced that a Bharatiya Janata Party (BJP) employee had been taken into custody by the National Investigation Agency (NIA) in relation to the Rameshwaram Cafe blast.</p>

<p>NIA, however, made no mention of any such material in its press release and issued a warning against the dissemination of unconfirmed news reports.
</p>
	<p>The NIA said in a statement that as part of the investigation into the March 1 Rameshwaram Cafe Blast at ITPL Road in Bengaluru, it has identified Abdul Matheen Taahaa as a co-conspirator and one Mussavir Hussain Shazib as the accused IED blaster. Both individuals reside in Thirthahalli in the Shivamogga district.</p>

<p>"NIA has been calling and questioning all of the acquaintances, including college and school classmates of the accused individuals who have been arrested and absconding, in order to obtain information and evidence for the investigation. Since this is a terror occurrence, knowing the identities of the witnesses could jeopardize their summons in addition to impeding the investigation, according to the NIA.
</p>
	<p>The Karnataka health minister posted on X that the BJP employee was arrested in Thirthahalli, in the Shimoga district.</p>
	<p>"BJP leader has been taken into custody by the National Investigation Agency in connection with the Rameswaram Cafe blast case," he wrote in his post.

Now if our government is to blame for the explosion, what would the state's saffron buds say? Given that an NIA-arrested BJP leader, doesn't this imply that the party is complicit in the Rameswaram cafe explosion? Does this prove beyond a doubt that the BJP's saffron terrorism, which it is waging in the state under the guise of religious protection, is causing major problems? "What response does this receive from the central BJP, which is forcing RSS doctrines on the nation?" he continued.
</p>
	<blockquote class="twitter-tweet"><p lang="kn" dir="ltr">ರಾಮೇಶ್ವರಂ ಕೆಫೆ ಸ್ಫೋಟ ಪ್ರಕರಣಕ್ಕೆ ಸಂಬಂಧಿಸಿದಂತೆ ತೀರ್ಥಹಳ್ಳಿಯ ಬಿಜೆಪಿ ಮುಖಂಡ ಸಾಯಿಪ್ರಸಾದ್‌ನನ್ನು ರಾಷ್ಟ್ರೀಯ ತನಿಖಾ ದಳದವರು ವಶಕ್ಕೆ ಪಡೆದಿದ್ದಾರೆ.<br><br>ಸ್ಫೋಟಕ್ಕೆ ನಮ್ಮ ಸರ್ಕಾರವೇ ಕಾರಣ ಅನ್ನೋವಂತೆ ಮಾತಾನಾಡುತ್ತಿದ್ದ ರಾಜ್ಯದ ಕೇಸರಿ ಕಲಿಗಳು ಈಗ ಏನು ಹೇಳುತ್ತಾರೆ? ಬಿಜೆಪಿ ಮುಖಂಡನನ್ನು NIA ವಶಕ್ಕೆ ಪಡೆದಿದೆ ಎಂದ ಮೇಲೆ… <a href="https://t.co/gygIPjGuBK">pic.twitter.com/gygIPjGuBK</a></p>&mdash; Dinesh Gundu Rao/ದಿನೇಶ್ ಗುಂಡೂರಾವ್ (@dineshgrao) <a href="https://twitter.com/dineshgrao/status/1776197126478868954?ref_src=twsrc%5Etfw">April 5, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
	<p>Muzammil Shareef, the blast's alleged primary mastermind, was already detained by the NIA, which assumed responsibility for the probe on March 13. Raids in Tamil Nadu, Uttar Pradesh, and Karnataka were preceded by Shareef's arrest.</p>
	<blockquote class="twitter-tweet"><p lang="zxx" dir="ltr"><a href="https://t.co/SLJgVBPISA">pic.twitter.com/SLJgVBPISA</a></p>&mdash; NIA India (@NIA_India) <a href="https://twitter.com/NIA_India/status/1776218614947012819?ref_src=twsrc%5Etfw">April 5, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
	<p>Mussavir Shazeeb Hussain, the main suspect, and Abdul Matheen Taha, a co-conspirator, have not yet been taken into custody.

An IED was used in the March 1 explosion at the restaurant on ITPL road in Bengaluru's Brookefield neighborhood, injuring patrons as well as employees and causing property damage.</p>
</div>
